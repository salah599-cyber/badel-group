        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4">
          {posts.map((post) => (
            ...
            >
              ...
              {post.caption && (
                <p className="absolute inset-x-0 bottom-0 translate-y-full bg-gradient-to-t from-black/80 to-transparent p-4 text-xs font-medium text-white transition duration-300 group-hover:translate-y-0">
