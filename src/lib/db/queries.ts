...
function tournamentSelect() {
  return db!.select({
    ...
    superTiebreakPoints: tournaments.superTiebreakPoints,
    teamsPerGroup: tournaments.teamsPerGroup,
    advancePerGroup: tournaments.advancePerGroup,
    knockoutStartRound: tournaments.knockoutStartRound,
    thirdPlacePlayoff: tournaments.thirdPlacePlayoff,
    pointsWin: tournaments.pointsWin,
    pointsLoss: tournaments.pointsLoss,
    groupDrawSeed: tournaments.groupDrawSeed,
    championTeamId: tournaments.championTeamId,
